...
<h1 class="text-3xl"># Explorando Funciones de ES6</h1>
# Explorando Funciones de ES6

<p class="my-5">JavaScript ES6 introdujo varias funciones nuevas que han hecho que la codificación en JavaScript sea más eficiente y agradable. Vamos a explorar algunas de estas funciones.</p>
